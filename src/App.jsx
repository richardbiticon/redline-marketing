...
const NicheShowcase = ({ navigate }) => {
  ...
  return (
    <section style={{ background: C.black, padding: "80px 60px 60px", position: "relative", overflow: "hidden" }}
...
const AboutPage = ({ navigate }) => (
  <>
    <section style={{ position: "relative", padding: "80px 60px", background: C.black, overflow: "hidden" }}>
...
const BlogPostPage = ({ navigate }) => (
  <>
    <section style={{ padding: "60px 60px 0", maxWidth: 820, margin: "0 auto" }}>
